...
import {
  ...
  RSC_HEADER,
} from '../../../packages/next/src/client/components/app-router-headers'
import { defaultConfig } from '../../../packages/next/src/server/config-shared'
import { createRequestResponseMocks } from '../../../packages/next/src/server/lib/mock-request'
import {
  buildCustomRoute,
  setupFsCheck,
} from '../../../packages/next/src/server/lib/router-utils/filesystem'
import { getResolveRoutes } from '../../../packages/next/src/server/lib/router-utils/resolve-routes'
import { getRequestMeta } from '../../../packages/next/src/server/request-meta'
...
type ResolveRoutesOptions = Parameters<typeof getResolveRoutes>[2]
type RenderServer = Parameters<typeof getResolveRoutes>[3]
...
type FsCheckerOverrides = {
  ...
  handleLocale?: FsChecker['handleLocale']
  buildId?: string
}
...
function createOutput(
  itemPath: string,
  type: FsOutput['type'] = 'pageFile',
  extra: Partial<FsOutput> = {}
): FsOutput {
...
function createMiddlewareMatcher(
  ...
  } as FsChecker['middlewareMatcher']
}
